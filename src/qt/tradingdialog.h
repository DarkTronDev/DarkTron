...
private slots:
    ...
    void on_BuyDRKT_clicked();
    void on_SellDRKTBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputDRKT_textChanged(const QString &arg1);
    ...
    QString BuyDRKT(QString OrderType, double Quantity, double Rate);
    QString SellDRKT(QString OrderType, double Quantity, double Rate);
