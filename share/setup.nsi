...
!define URL http://www.darktron.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/darktron.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\darktron-qt.exe
...
OutFile darktron-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/darktron-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/darktrond.exe
    ...
    #Delete /REBOOTOK $INSTDIR\darktron.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\darktron-qt.exe
